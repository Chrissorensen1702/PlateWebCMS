...
@section('content')
    @php
        ...
        $headerCtaLabel = $header?->cta_label ?: 'Book tid';
        $headerCtaHref = \App\Support\Http\PublicSiteUrl::sanitize($header?->cta_href) ?: $bookingHref;
    @endphp
            ...
            <div class="ui-shell site-theme-header__inner">
                ...
                <div class="site-theme-header__actions">
                    ...
                    @if ($showHeaderCta && $headerCtaLabel && $headerCtaHref)
                        <a href="{{ $headerCtaHref }}" class="ui-button ui-button--accent site-theme-booking">
                            {{ $headerCtaLabel }}
                        </a>
                    @endif
                </div>
